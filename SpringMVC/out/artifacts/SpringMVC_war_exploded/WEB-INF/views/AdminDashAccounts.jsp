                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="font-medium"><c:out value="${student.username}"/></span>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-6 text-center">
                                <c:choose>
                                    <c:when test="${student.validated != '0'}">
                                        <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Confirmed</span>
                                        <br />
                                    </c:when>
                                    <c:otherwise>
...
<div class="w-1/5 h-screen bg-gray-100">
    ...
    <!-- Cards -->
    <c:forEach items="${requestScope.students}" var="student">
    <form method="post" action="validatedaccount" class="w-5/6 h-screen m-auto bg-white rounded-xl mt-8 overflow-auto ">
        <div class="flex relative ">
            <div class="w-5/6 relative top-2 left-2">
                <h1><c:out value="${student.username}"/></h1>
                <h6><c:out value="${student.email}"/></h6>
            </div>
